---
title: "Formulación de proyectos para ciencia de datos en política pública"
...
## ¿Por qué la formulación de proyectos es crítica?
### Importancia del alcance o *scoping*

-   Un proyecto bien definido aumenta la probabilidad de que tu trabajo sea utilizado y tenga un impacto
...
-   Comenzamos con el problema (no con los datos) y llegamos al alcance que nos permite conectar los datos para informar las acciones para alcanzar nuestras metas. 
...
### Criterios iniciales de evaluación para un proyecto de DS en PP
...
- ¿Cuál es la magnitud del problema: a quién o qué afecta? ¿Cuánto les afecta?
...
## Ejercicio: ¿Cuáles de estas son metas razonables para un proyecto de DS?

- Mejorar la calidad educativa en las escuelas públicas de la Ciudad de México
- Enseñar a los estudiantes cómo hacer proyectos de ciencia de datos
- Minimizar el tiempo de espera de los pacientes en urgencias
- Reducir el tiempo promedio de traslado al trabajo
...
- ~~Enseñar a los estudiantes cómo hacer scoping~~ *(es una actividad, no una meta de impacto)*
    - Maximizar la probabilidad de que puedas hacer scoping de un proyecto correctamente en el futuro después del curso
- Minimizar el tiempo de espera de los pacientes en urgencias ✓
- Reducir el tiempo promedio de traslado al trabajo ✓
...
> El trabajo que hacemos solo puede tener un impacto si es accionable.
...
- Centro de salud mental realizando **acercamientos en salud mental**
- Una organización sin fines de lucro **enviando correos dirigidos** a posibles donantes
...
- Acercamientos en salud mental 
    - **para prevenir crisis**

- Correos dirigidos a posibles donantes 
...
**Datos para informar las acciones:**

- Actualizados al menos con la misma frecuencia que la acción
...
::: {.callout-important}
Si los datos para medir la meta y los datos para informar la acción
no están sincronizados en tiempo y granularidad, el modelo puede ser
técnicamente correcto pero llegar demasiado tarde o al nivel equivocado
...
|---|---|---|
| **Descripción** | Entender el pasado | ¿Cuántos estudiantes no se graduaron a tiempo el año pasado? |
| **Detección** | Identificar un patrón en el estado actual | Detectar transacciones fraudulentas; identificar patrones de tráfico inseguros |
| **Predicción** | Predecir un estado futuro | Predecir la probabilidad de quedarse sin hogar en el próximo año |
| **Optimización** | Asignar / programar recursos | ¿Dónde colocar ambulancias para minimizar el tiempo de respuesta? |
| **Cambio de comportamiento / Inferencia causal** | Efectividad de intervenciones | ¿Qué programa extracurricular sería más beneficioso para este estudiante? |
...
|---|---|---|
| **Descripción** | ¿Qué ha pasado? | ¿Cuántos estudiantes desertaron el semestre pasado y en qué momento? |
| **Detección** | ¿Qué es inusual? | ¿Qué tuberías muestran patrones de falla atípicos? |
| **Predicción** | ¿Qué pasará? ¿A quién le pasará? | ¿Qué estudiantes tienen mayor riesgo de no graduarse? |
| Optimización | ¿Cuál es la mejor asignación de recursos? | ¿A qué estudiantes asignar los pocos tutores disponibles? |
| Inferencia causal | ¿Qué funciona? | ¿La tutoría realmente redujo la deserción o solo atendió a quienes ya iban a graduarse? |
...
- [ ] ¿Qué tipo de análisis es? (Descripción / Detección / Predicción / Cambio de comportamiento / Optimización)
...
- ¿Las personas cuyos datos se usan saben que se están utilizando?
...
- No tengas miedo de hacer preguntas "ingenuas"
- Debemos abordar estos problemas de manera responsable y ética
- Dedica tiempo a discutir metas y métricas — no olvides la equidad como meta
- Entiende cuál es el proceso o solución actual
- La comunicación es crítica — antes, durante y después
- Los datos y la tecnología no resuelven problemas, las personas sí
